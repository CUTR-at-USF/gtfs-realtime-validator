...
public class StopTimeUpdateValidatorTest extends FeedMessageTest {
     ...
     *
     * Note that Note that the validator checks if stop_sequence and stop_id pairing from GTFS match GTFS-realtime
     * in E045, and if stop_sequences are out of order in E002.  Therefore, these rules may flag some invalid
     * stop_sequences in GTFS-realtime data.  If E045 or E002 are triggered, E051 will not be logged to avoid duplicate
     * errors for the same problem and improve validator performance.
     *
     * See https://github.com/CUTR-at-USF/gtfs-realtime-validator/issues/261
     */
    @Test
    public void testE051() {
        ...
        /*
        The below cases confirm that other rules catch other situations where GTFS-rt stop_sequence doesn't exist in GTFS stop_times.txt
         */

        // Both stop_sequence and stop_id are included, with the wrong stop_sequence 250 being added in the middle of trip - 1 occurrence of E002 (out of order)
        tripUpdateBuilder.clearStopTimeUpdate();
        stopTimeUpdateBuilder.clear();
        ...
        // Only stop_sequence is included, with the wrong stop_sequence 250 being added in the middle of trip - 1 occurrence of E002 (out of order)
        tripUpdateBuilder.clearStopTimeUpdate();
        stopTimeUpdateBuilder.clear();
